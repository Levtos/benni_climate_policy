...
SELECTORS.update({
    ...
    OPT_BATH_HUMIDITY_ACUTE_RISE_THRESHOLD: PERCENT_FLOAT,
    ...
    OPT_BATH_HUMIDITY_GROUND_HEAT_THRESHOLD: PERCENT_FLOAT,
    OPT_BATH_DEWPOINT_GROUND_HEAT_THRESHOLD: selector.NumberSelector(selector.NumberSelectorConfig(min=-20, max=40, step=0.5, mode="box")),
    OPT_BATH_HUMIDITY_GROUND_HEAT_TEFF_LIMIT: THRESHOLD_FLOAT,
    OPT_BATH_HUMIDITY_GROUND_HEAT_TARGET: TEMP_FLOAT,
    OPT_BATH_HUMIDITY_GROUND_HEAT_OFF_AT: TEMP_FLOAT,
...
def _defaults(hass, data: dict[str, Any], keys: tuple[str, ...]) -> dict[str, Any]:
    ...
    tuning_defaults.update({
        ...
        OPT_BATH_HUMIDITY_ACUTE_RISE_THRESHOLD: bath_tuning.humidity_acute_rise_threshold,
        ...
        OPT_BATH_HUMIDITY_GROUND_HEAT_THRESHOLD: bath_tuning.humidity_ground_heat_threshold,
        OPT_BATH_DEWPOINT_GROUND_HEAT_THRESHOLD: bath_tuning.dewpoint_ground_heat_threshold,
        OPT_BATH_HUMIDITY_GROUND_HEAT_TEFF_LIMIT: bath_tuning.humidity_ground_heat_teff_limit,
        OPT_BATH_HUMIDITY_GROUND_HEAT_TARGET: bath_tuning.humidity_ground_heat_target,
        OPT_BATH_HUMIDITY_GROUND_HEAT_OFF_AT: bath_tuning.humidity_ground_heat_off_at,
